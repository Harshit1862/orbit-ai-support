// Knowledge base for "Orbit", a fictional project-management SaaS.
// The assistant may only state Orbit-specific facts that appear here.

export interface Faq {
  id: string;
  question: string;
  answer: string;
  /** The screen in the Orbit app where the user can do this. */
...
export const FAQS: Faq[] = [
  {
    ...
    answer:
      "Customers can request a full refund within 30 days of purchase, on both monthly and annual plans. Go to Settings → Billing → Request refund, or email billing@orbit.example. Refunds go back to the original payment method within 5–7 business days.",
    link: { href: "/app/settings/billing", label: "Open Billing" },
  },
  {
    id: "password-reset",
    ...
    link: { href: "/login?forgot=1", label: "Reset password" },
  },
  {
    id: "plans-pricing",
    ...
    link: { href: "/app/settings/billing", label: "Compare plans" },
  },
  {
    id: "change-plan",
    ...
    link: { href: "/app/settings/billing", label: "Change plan" },
  },
  {
  ...
  },
  {
    ...
    link: { href: "/app/settings/members", label: "Invite members" },
  },
  {
    id: "two-factor",
    ...
    link: { href: "/app/settings/security", label: "Open Security" },
  },
  {
    id: "data-export",
    ...
    link: { href: "/app/settings/workspace", label: "Export data" },
  },
  {
    id: "contact-support",
    question: "How do I contact a human / what are your support hours?",
    answer:
      "Email support@orbit.example or use live chat, Monday to Friday, 9:00–18:00 IST. Business plan customers get priority support with a 4-hour response time.",
    link: { href: "/app/support", label: "Contact support" },
  },
  {
    id: "integrations",
    question: "Which integrations do you support?",
    answer:
      "Orbit integrates with Slack, Google Drive, GitHub and Zapier. Connect them from Settings → Integrations.",
    link: { href: "/app/settings/integrations", label: "Open Integrations" },
  },
];
